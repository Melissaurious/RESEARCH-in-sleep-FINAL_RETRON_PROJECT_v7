...
|---|---|---|
| **Route S — source-stated residue coordinate** | a residue boundary stated in a primary source. In the whole held corpus this is **only** Blocker 2005 on LtrA: RT0 = M1–R85, RT1/7 = R86–R364, and the conserved RT0 alanine at A39 | **yes**, and it is the strongest evidence available — but it is one protein, so what it resolves is a **LtrA-local** correspondence, never a portable cross-family one |
